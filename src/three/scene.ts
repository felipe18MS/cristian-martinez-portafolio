...
/**
 * Libera una textura asociada a un material y después
 * libera el propio material.
 */
...
/**
 * Libera geometrías, materiales y texturas de todos
 * los objetos contenidos dentro de la escena.
 */
function disposeObject(object: THREE.Object3D) {
  object.traverse((child) => {
    const resource = child as THREE.Mesh;

    // Geometrías de Mesh, Line, Points, GridHelper, etc.
    if ('geometry' in resource && resource.geometry) {
      resource.geometry.dispose();
    }

    // Materiales simples o arrays de materiales.
